...
//!
//! The tessellators are generic over a type implementing the
...
//! model.
//!
//! Each application can implement the ```BezierGeometryBuilder<Point>``` trait in order to
//! control how the ouput geometry is stored.
